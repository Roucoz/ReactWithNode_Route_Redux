...
import { Image, Col, Row, Form, InputGroup, FormControl, Button } from 'react-bootstrap';
import '../styles/glob.css'
import Autocompletes from '../components/Autocomplete'



const renderCard = (image, title) => {
    return (
        <div className='flexrow wrap pt-4 end' >
            <Image src={image} className='circleImage ' />
            <div className='col-8 flexcolumn spacearround  '>
...
class MainContect extends Component {
    ...
    render() {
        return (
            <div className='p-5' >
                <form name="signIN" className="contactform" onSubmit={this.contactSubmit.bind(this)}>
                ...
                <Autocompletes suggestions={['rouoz', 'Elias', 'Charble']} />
